...
module iso_triangle(side, tall, corner_radius, triangle_height) {
  ...
  translate([0, corner_radius, 0]) {
    hull() {
      translate([side / 2 - corner_radius, 0]) cylinder(r=corner_radius, h=triangle_height);
      translate([-side / 2 + corner_radius, 0]) cylinder(r=corner_radius, h=triangle_height);
      translate([0, tall - corner_radius * 2, 0]) cylinder(r=corner_radius, h=triangle_height);
    }
  }
}
