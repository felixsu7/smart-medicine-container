...
public:
  ...
  // room for new logs, clears the oldest log and place the new log there
  // instead. Returns -1 if the index is out of bounds.
  int log(int idx, const struct AlarmLog *log);
