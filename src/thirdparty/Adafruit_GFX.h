...
class Adafruit_GFX : public Print {
  ...
  */
  /**********************************************************************/
  void setTextColor(uint32_t c) { textcolor = textbgcolor = c; }
 ...
 protected:
  ...
  uint32_t textcolor;    ///< 16-bit background color for print()
  uint32_t textbgcolor;  ///< 16-bit text color for print()
...
//  A GFX 18-bit canvas context for graphics
class GFXcanvas18 : public Adafruit_GFX {
 public:
