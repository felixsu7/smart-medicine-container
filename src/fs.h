...
// Formats the Filesystem, clearing all saved data. Returns if the operation is
// successful or not.
bool fs_format(void);

// Loads a file from the path in the filesystsem into dest with specified size.
// Returns -1 if the file doesn't exist. Returns -2 if the file actual size is
// different from specified size. TODO FIXME
